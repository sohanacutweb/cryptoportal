<!-- start footer Area -->		
			<footer class="footer-area section-gap col-lg-12">
				<div class="container">
					<div class="row">
            ...
            <p class="col-lg-8 col-sm-12 footer-text m-0 text-white">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="" target="_blank">Acutweb</a></p>
			...
			<script src="<?php echo base_url();?>assets/frontend/js/jquery.DonutWidget.min.js"></script>
